...
- Latest one-byte comparison note: a separately approved one-byte SetFanMax comparison gate now requires its own explicit flag and all existing runtime gates; neither payload is validated and normal control remains NO-GO.
