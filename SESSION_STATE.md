...
- Current objective: keep HP diagnostics read-only while retaining the SetFanMax payload decision at NO-GO
- Last completed work: audited local SetFanMax payload-length reference evidence without selecting a length
