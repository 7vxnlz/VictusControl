...
- Latest schema-v2 note: HP diagnostic report JSON construction now has direct test coverage for schema-v2 SetFanMax experimental status persistence; old reports remain fail-closed.
