...
- Latest developer-experiment note: cached HP diagnostics distinguish a limited four-byte developer-only experiment allowance from normal fan control, which remains NO-GO; missing/old report fields fail closed.
